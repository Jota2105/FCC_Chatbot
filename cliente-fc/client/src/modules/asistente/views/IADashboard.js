  ...
  const menuItems = [
    {
      ...
      description: 'Sube y administra los documentos PDF que la IA debe aprender.',
    ...
    },
    {
      ...
      description: 'Revisa qué han preguntado los empleados y qué respondió la IA.',
      // CORRECCIÓN AQUÍ: Convertimos el objeto en un Elemento JSX < />
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3, mt: 8 }}>
        <Container maxWidth="lg">
          <Typography 
            ...
            component="h1" 
            gutterBottom 
            sx={{ color: 'primary.main', fontWeight: 'bold', mb: 4, textAlign: 'center' }}
          >
